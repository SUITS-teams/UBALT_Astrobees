import { open, read, close } from '../fs-promised.js';
...
function randomFillSync(buffer, rawOffset, rawSize) {
    getRandomValues(normalizeOffsetBuffer(buffer, rawOffset, rawSize));
    return buffer;
}
function randomFill(buffer, rawOffset, rawSize, rawCallback) {
...
export { createHash, randomBytes, randomFill, randomFillSync };
