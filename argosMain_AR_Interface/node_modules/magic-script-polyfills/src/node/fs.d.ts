...
export declare function readdirPromised(path: string): Promise<string[]>;
...
export declare function stat(path: string, callback: OnResult<Stats>): void;
export declare function statSync(path: string): Stats;
export declare function fstat(fd: number, callback: OnResult<Stats>): void;
export declare function fstatSync(fd: number): Stats;
export declare function lstat(path: string, callback: OnResult<Stats>): void;
...
export declare function realpath(path: string, callback: OnResult<string>): void;
export declare function realpathSync(path: string): string;
declare function realpathPromised(path: string): Promise<string>;
...
export declare const promises: {
    ...
    readdir: typeof readdirPromised;
    realpath: typeof realpathPromised;
};
export {};
