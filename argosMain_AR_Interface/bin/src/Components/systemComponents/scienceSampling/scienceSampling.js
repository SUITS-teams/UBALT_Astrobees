...
import { scienceMenuButton, paginationButton } from '../../uiComponents/ButtonArgos.js';
import { scienceSamplingMenuButtons, scienceSamplingSteps } from '../../uiComponents/globalVariables.js';
import { initHorizontalToolKitView } from '../toolKit/toolKit.js';

function initScienceSamplingView (prism, mainPrism) {
...
export { initScienceSamplingView, setStep };
